...
//		{ "COLOR", 0, DXGI_FORMAT_R32G32B32A32_FLOAT, 0, 12, D3D12_INPUT_CLASSIFICATION_PER_VERTEX_DATA, 0 },
	...
	_pipelineDesc.RasterizerState = CD3DX12_RASTERIZER_DESC(D3D12_DEFAULT);				// 옵션 수정 SkyBox의 경우 큐브와 달리 와인딩오더가 반대일 때 보여져야 함.
	_pipelineDesc.BlendState = CD3DX12_BLEND_DESC(D3D12_DEFAULT);
	_pipelineDesc.DepthStencilState = CD3DX12_DEPTH_STENCIL_DESC(D3D12_DEFAULT);		// 옵션 수정
	...
	case SHADER_TYPE::FORWARD:
		_pipelineDesc.NumRenderTargets = 1;
		_pipelineDesc.RTVFormats[0] = DXGI_FORMAT_B8G8R8A8_UNORM;
	case SHADER_TYPE::LIGHTING:
		_pipelineDesc.NumRenderTargets = 2;
		_pipelineDesc.RTVFormats[0] = DXGI_FORMAT_B8G8R8A8_UNORM;
		_pipelineDesc.RTVFormats[1] = DXGI_FORMAT_B8G8R8A8_UNORM;
		break;
	}
